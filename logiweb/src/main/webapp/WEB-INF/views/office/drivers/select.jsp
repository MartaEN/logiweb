        ...
        <div>
            ...
            <form:form modelAttribute="driverSelectForm" action="/tickets/${ticketId}/finalize" method="post">
                <div class="form-group">
                    <%--вылетает с ошибкой org.springframework.beans.NotReadablePropertyException: Invalid property '' of bean class [DriverRecord]: Bean property '' is not readable or has an invalid getter method: Does the return type of the getter match the parameter type of the setter?--%>
