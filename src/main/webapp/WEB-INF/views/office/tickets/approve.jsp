...
<%@ page import="com.marta.logistika.entity.TripTicketEntity" %>
<%@ page import="com.marta.logistika.dto.TripTicketRecord" %>
...
<div class="col-sm-6">
    ...
    <div>
        <div class="form-group row">
            ...
            <span class="col-sm-7"><i class="fas fa-calendar-alt"></i> ${ticket.departureDateTime.substring(0,10)}
                ...
                <a data-toggle="collapse" href="#dateTimeEditCollapse" role="button" aria-expanded="false" aria-controls="collapseExample"><i class="fas fa-pencil-alt"></i></a>
            </span>
        </div>
        <div class="collapse" id="dateTimeEditCollapse">
            <form:form modelAttribute="departureDateTime" method="post" action="${contextPath}/tickets/${ticket.id}/update-departure">
                <div class="form-group row">
                    <form:label path="departureDateTime" cssClass="col-sm-5 col-form-label">Перенести на более позднее время:  </form:label>
                    <div class="input-group mb-3 col-sm-7">
                        <form:input path="departureDateTime" type="datetime-local" cssClass="form-control" required="true" min="${minNewDateTime}"/>
    ...
    <div class="form-group">Назначена фура ${ticket.truck.regNumber}, грузоподъемность ${ticket.truck.capacity} кг</div>
