...
public class ExceptionHandlingControllerAdvice {
    ...
    /**
     * Provides custom error page for all unmapped requests
     * @param e incoming exception
     * @param uiModel model
     * @return path to jsp error page
     */
    @ExceptionHandler(NoHandlerFoundException.class)
    public String handleNoHandlerFoundException(final NoHandlerFoundException e, Model uiModel) {
        LOGGER.warn(e.getMessage());
        ErrorMessage errorMessage = new ErrorMessage();
        errorMessage.setTitle("error.smthWentWrong");
        errorMessage.setMessage("error.pageNotFound");
